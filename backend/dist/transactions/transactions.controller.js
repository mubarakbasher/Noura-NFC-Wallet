...
let TransactionsController = class TransactionsController {
    ...
    async validateAndProcessTransaction(userId, dto) {
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('MERCHANT', 'USER'),
    (0, common_1.HttpCode)(common_1.HttpStatus.OK),
    __param(0, (0, current_user_decorator_1.CurrentUser)('id')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.ValidateTransactionDto]),
    __metadata("design:returntype", Promise)
], TransactionsController.prototype, "validateAndProcessTransaction", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, dto_1.TransactionHistoryDto]),
    __metadata("design:returntype", Promise)
